...
public class ElevenLabsAPIManager : MonoBehaviour
{
    [SerializeField]
    ...
    public ElevenLabsAPIManager(string apiKey, string voiceId)
    {
        _apiKey = apiKey;
        _voiceId = voiceId;
    }
    ...
    IEnumerator DoRequest(string message)
    {
        ...
        var url = "https://api.elevenlabs.io/v1/text-to-speech/21m00Tcm4TlvDq8ikWAM/stream";
